var appCfg ={
    navRoutes:[        
        ...
        {navItem:true, path:"/crossfit",name:"Crossfit",view:"app/views/crossfit.html"},
        {navItem:true, path:"/fitness",name:"Fitness",view:"app/views/fitness.html"},
        {navItem:true, path:"/movement",name:"Movement",view:"app/views/movement.html"},
